...
StaticMaskExtractor_DualBkg::StaticMaskExtractor_DualBkg(Mat sampleFrame, double _framerate, double time_to_static, BkgSubtractionSelector *bgS, double alpha) :StaticMaskExtractor(sampleFrame, _framerate, time_to_static)
{
