...
int main(int argc, char *argv[])
{
    ...
    else
    {
        ...
        cfg.init(4,3,3,1, "./../datasets/AVSS2007/AVSSS07_MEDIUM.mpg","./../results/",30,DEFAULT_FLAG_NEARPEOPLE, DEFAULT_FLAG_MASK);
       // cfg.init(4,2,1,3, "./../datasets/AVSS2007/AVSSS07_MEDIUM.mpgPETS2006_S5/PETS2006_S5_C3.mpeg","./../results/",30,DEFAULT_FLAG_NEARPEOPLE, DEFAULT_FLAG_MASK);
    }
