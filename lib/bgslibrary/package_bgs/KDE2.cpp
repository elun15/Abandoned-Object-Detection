...
//default timessizew 100

KDE2::KDE2(int rate)
  //SequenceLength(50), TimeWindowSize(100), SDEstimationFlag(1), lUseColorRatiosFlag(1),
  //th(10e-8), alpha(0.3), framesToLearn(rate), frameNumber(0)
//SequenceLength(50), TimeWindowSize(100), SDEstimationFlag(1), lUseColorRatiosFlag(1),
//th(10e-8), alpha(rate), framesToLearn(10), frameNumber(0)
{
  p = new NPBGSubtractor;
  std::cout << "KDE2()" << std::endl;
