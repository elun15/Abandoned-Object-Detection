...
IndependentMultimodalBGS::IndependentMultimodalBGS() : fps(25), firstTime(true), showOutput(false){
...
{
  CvFileStorage* fs = cvOpenFileStorage("../../../lib/bgslibrary/config/IndependentMultimodalBGS.xml", 0, CV_STORAGE_WRITE);
...
{
  CvFileStorage* fs = cvOpenFileStorage("./../../lib/bgslibrary/config/IndependentMultimodalBGS.xml", 0, CV_STORAGE_READ);
